				...
				<table id="return" style="display:none" >
					<tr>
						...
						<td width="100%" align="center">
							<s:a action="order_inStoreList.action" style="color:#f00;font-size:20px;padding-top:2px;font-weight:bold;text-decoration:none;width:82px;height:28px;display:block;background:url(images/btn_bg.jpg)">
								返回
							</s:a>
						</td>
						<td>&nbsp;</td>
