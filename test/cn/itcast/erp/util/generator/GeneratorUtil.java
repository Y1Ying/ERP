...
public class GeneratorUtil {
	...
	public static void main(String[] args) throws Exception {
		// EmpModel,RoleModel,ResModel,GoodsModel,OrderModel,OrderDetailModel,StoreModel
		new GeneratorUtil(StoreModel.class);
	...
	private void generatorEbo() throws Exception {
		...
		bw.write("	public List<"
				+ b
				+ "Model> getAll(BaseQueryModel qm, Integer pageNum,Integer pageCount) {");
		bw.newLine();
